...
\begin{enumerate}
    ...
    \end{equation*}
    \item Calculate $\langle \hat n_k \rangle$ for free non-interacting bosons!
    \par \textit{Solution.}
    \begin{align*}
        \langle \hat n_k \rangle & = \langle \hat a_k^{\dagger}\hat a_k \rangle = \frac{1}{Z_G}\Tr{e^{-\beta \hat K}\hat a_k^{\dagger}\hat a_k} \\
        & = \frac{1}{Z_G} \sum\limits_{\{n_i\}}\braket{\dots, n_i, \dots, n_1|e^{-\beta \hat K}\hat a_k^{\dagger}\hat a_k|n_1,\dots, n_i, \dots}
    \end{align*}
